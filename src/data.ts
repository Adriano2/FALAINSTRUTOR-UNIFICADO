...
export const CONTEUDO_PROGRAMATICO: Record<string, string[]> = {
  ...
  "NR 06": [
    "Conceito de Equipamento de Proteção Individual (EPI) e diferença para o EPC",
    "Hierarquia das medidas de controle e o EPI como última barreira",
    "Certificado de Aprovação (CA): obrigatoriedade, validade e verificação",
    "Responsabilidades do empregador, do trabalhador e do fabricante/importador",
    "Tipos de EPI por região do corpo (cabeça, olhos, face, auditiva, respiratória, tronco, membros e proteção contra quedas)",
    "Critérios de seleção do EPI conforme a análise de risco (PGR)",
    "Uso correto, ajuste e inspeção antes do uso",
    "Higienização, guarda, conservação e vida útil",
    "Ficha de controle de entrega e fornecimento de EPI",
    "Inspeção, substituição e descarte de EPIs",
  ],
  "NR 10": [

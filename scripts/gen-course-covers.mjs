...
const COURSES = [
  ...
  ['course-nr05', 'NR 05', 'CIPA — Comissão Interna de Prevenção', '👥', '#27B074'],
  ['course-nr06', 'NR 06', 'Equipamentos de Proteção Individual', '🧤', '#F5B21A'],
  ['course-nr10', 'NR 10', 'Segurança em Eletricidade e SEP', '⚡', '#F5B21A'],
  ['course-nr11', 'NR 11', 'Movimentação e Armazenagem de Materiais', '📦', '#3B82F6'],
